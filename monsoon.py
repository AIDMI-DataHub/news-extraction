...
def run_monsoon_script():
    # Instead of from_/to_, use 'when' param
    when_parameter = '1d'
    ...
    monsoon_terms = [
        "Monsoon", "Heavy rainfall", "Thunderstorm",
    ...
    for region in states + union_territories:
        ...
        for lang_code in [region_lang, "en"]:
            ...
            all_entries = []
            try:
                # Use 'when=1d' to avoid "Could not parse your date"
...
def extract_results(results, term, lang_code):
    ...
    for entry in results.get('entries', []):
        ...
        extracted_entries.append([title, link, date, source, summary, place, term, lang_code])
